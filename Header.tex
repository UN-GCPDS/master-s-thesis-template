...
\hypersetup{
    ...
    pdftitle={A Deep Learning Approach for Image-based Semantic Segmentation with Preserved Interpretability - Juan Carlos Aguirre Arango}
    }
...
\providecommand{\promed}[1]{\ensuremath{\mathds{E}\left\lbrace#1\right\rbrace}} %Expected value
